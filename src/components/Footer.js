...
const Footer = () => {
  ...
  return (
    <div className="bg-[#666162] text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">
              R.K. Job Placement Services
            </h3>
            ...
            <div className="flex md:flex space-x-10  text-[#fc9704] flex-shrink-0 mt-5 ">
              <Facebook size={30} />
              <Instagram size={30} />
              <Youtube size={30} />
              <Twitter size={30} />
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-white">
          <p>
            &copy; {currentYear} R.K. Job Placement Services. All rights
            reserved.
          </p>
        </div>
      </div>
